...
#elif defined(CAMERA_MODEL_M5STACK_ESP32CAM_NO_PSRAM)
#define PWDN_GPIO_NUM     -1//
...
#define LED_PIN           4 // A status led on the RGB; could also use pin 0 or 4
#define LED_ON         HIGH // 
#define LED_OFF         LOW //
#define LAMP_PIN        16 // No LED FloodLamp.
///////////////////////////////////////////////////////////////////////////////////////
